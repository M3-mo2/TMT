...
# tickets
TICKETS = f"{PREFIX}:tickets"
TICKETS_ALL = f"{PREFIX}:tickets:all"
TICKETS_OPEN = f"{PREFIX}:tickets:open"
TICKETS_IN_PROGRESS = f"{PREFIX}:tickets:in_progress"
TICKETS_CLOSED = f"{PREFIX}:tickets:closed"
TICKETS_OPEN_TICKET = f"{PREFIX}:tickets:open:"
TICKETS_STATUS = f"{PREFIX}:tickets:status:"
TICKETS_PRIORITY = f"{PREFIX}:tickets:priority:"
TICKETS_REPLY = f"{PREFIX}:tickets:reply:"
TICKETS_CLOSE = f"{PREFIX}:tickets:close:"
